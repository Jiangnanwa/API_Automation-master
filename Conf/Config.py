...
class Config:
    ...
    '''
    D:\PythonLearning\apitest\API_Automation-master
    __file__ 当前文件
    os.path.dirname  当前文件的绝对目录
    os.path.join  拼接两个路径
    ...
    def get_conf(self, title, value):
        """
        配置文件读取，获取指定 key 的 value，也就是title对应的value
        :param title:
        :param value:
        :return:
        """
    ...
    def set_conf(self, title, value, text):
        """
        配置文件修改，相当于设置[title]下的value=text
        :param title:
        :param value:
        :param text:
        :return:
        ...
        with open(self.conf_path, "w+") as f:
            return self.config.write(f)    # 将修改的配置项写入配置文件
