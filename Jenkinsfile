        ...
        stage('Setup and Run') {
            steps {
                bat '''
                    ...
                    echo ===== Running run.py =====
                    :: 注意：请确保您的 run.py 内部执行了生成 allure-results 的逻辑 
                    :: 例如使用了 pytest --alluredir=allure-results
            ...
            emailext(
                ...
                body: """
                    ...
                    <ul>
                        ...
                        <li><strong>📊 Allure 测试报告：</strong> <a href="${env.BUILD_URL}allure/">👉 点击这里查看测试报告详情</a></li>
                    </ul>
            ...
            emailext(
                ...
                body: """
                    ...
                    <ul>
                        ...
                        <li><strong>📊 Allure 测试报告：</strong> <a href="${env.BUILD_URL}allure/">👉 点击这里查看详细报错报告</a></li>
                    </ul>
